    ...
    <div className="min-h-screen bg-white font-sans tracking-tight">
      ...
      <div className="relative py-20 px-4">
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="w-full max-w-6xl h-128 bg-[#F8F3EA] rounded-b-[50%] shadow-2xl flex items-end justify-center pb-8">
      ...
      <div className="max-w-7xl mx-auto px-4 pb-20 mt-64">
        <div className="grid md:grid-cols-3 gap-6">
          ...
          {/* BOX 3 - How It Works */}
          <div className="bg-[#fff] border-2 border-black shadow-[8px_8px_0_0_#2A7E21] p-6 rounded-lg">
          <h2 className="text-xl font-black mb-4 text-[#F8F3EA] bg-black px-3 py-2 rounded-lg inline-block">
                How It Works
              </h2>
            <p className="text-sm text-black mb-4 leading-relaxed">
        ...
        <div className="text-center mt-12">
          <button className="bg-[#F8F3EA] border-2 border-black shadow-[6px_6px_0_0_#2A7E21] px-8 py-4 rounded-lg text-lg font-bold text-black hover:bg-[#F8F3EA]/90 hover:shadow-[4px_4px_0_0_#2A7E21] hover:translate-x-[2px] hover:translate-y-[2px] transition-all duration-200 active:shadow-[2px_2px_0_0_#2A7E21] active:translate-x-[4px] active:translate-y-[4px]">
            Join the Waitlist
          </button>
           <button className="bg-[#F8F3EA] ml-[20px] border-2 border-black shadow-[6px_6px_0_0_#2A7E21] px-8 py-4 rounded-lg text-lg font-bold text-black hover:bg-[#F8F3EA]/90 hover:shadow-[4px_4px_0_0_#2A7E21] hover:translate-x-[2px] hover:translate-y-[2px] transition-all duration-200 active:shadow-[2px_2px_0_0_#2A7E21] active:translate-x-[4px] active:translate-y-[4px]">
           <a href="/launch">Launch App</a>
          </button>
        </div>

        {/* MORE WHITE CONTENT */}
        <div className="mt-12 bg-white border-2 border-black shadow-[8px_8px_0_0_#2A7E21] p-8 rounded-lg">
          <h3 className="text-2xl font-black mb-4 text-[#F8F3EA] bg-black px-4 py-2 rounded-lg inline-block">
